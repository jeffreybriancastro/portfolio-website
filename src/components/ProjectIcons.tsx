...
/** Pipeline: three stage columns, the cards stepping up a stage on hover. */
export function CrmIcon({ size = 22 }: IconProps) {
  return (
    <svg className="picon" width={size} height={size} {...base}>
      ...
      <path className="picon__line picon__line--1" d="M4.75 8h1" />
      <path className="picon__line picon__line--2" d="M11.5 8h1" />
      <path className="picon__cable" d="M18.25 8h1" />
    </svg>
  )
}

/** A shipped site: a browser frame whose content settles in on hover. */
export function SiteIcon({ size = 22 }: IconProps) {
  return (
    <svg className="picon" width={size} height={size} {...base}>
      <rect x="3" y="4" width="18" height="16" rx="2" />
      <path d="M3 9h18" />
      <path className="picon__line picon__line--1" d="M6.5 13h5" />
      <path className="picon__line picon__line--2" d="M6.5 16.5h8" />
    </svg>
  )
}
