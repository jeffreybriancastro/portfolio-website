...
// x,y = top-left of the node box on the 1000x372 canvas.
// Two tiers: the chain across the top, the outcomes fanning out just below.
// These are the real stages of the booking pipeline on the Projects page -
// workflows 001 to 006 - not an illustrative flow.
const NODES: FlowNode[] = [
  // top chain: the enquiry's happy path
  { id: 'n-form',     Icon: Lightning,      title: 'Enquiry in',    subtitle: 'Messenger or form', x: 6,   y: 36,  variant: 'trigger' },
  { id: 'n-email',    Icon: EnvelopeSimple, title: 'Tag & assign',  subtitle: 'Owner set in GHL',  x: 176, y: 36 },
  { id: 'n-booked',   Icon: CalendarCheck,  title: 'Opportunity',   subtitle: 'Created on the board', x: 346, y: 36 },
  { id: 'n-24hr',     Icon: Clock,          title: 'Wait 1 hour',   subtitle: 'Did they book?',    x: 516, y: 36 },
  { id: 'n-1hr',      Icon: BellRinging,    title: 'Reminders',     subtitle: 'Email & SMS',       x: 686, y: 36 },
  { id: 'n-call',     Icon: VideoCamera,    title: 'Appointment',   subtitle: 'Attended?',         x: 866, y: 36, variant: 'gate' },
  // outcomes (one tier, fanning out of the decision gate)
  { id: 'n-proposal', Icon: FileText,       title: 'Attended',      subtitle: 'Thanked, stage moves', x: 56,  y: 268 },
  { id: 'n-won',      Icon: Trophy,         title: 'Repeat client', subtitle: 'Promo a week later', x: 240, y: 268, variant: 'win' },
  { id: 'n-maybe',    Icon: Hourglass,      title: 'No show',       subtitle: 'Chased to rebook',  x: 468, y: 268 },
  { id: 'n-nurture',  Icon: Heart,          title: 'Re-engagement', subtitle: 'Three emails, two months', x: 652, y: 268 },
  { id: 'n-lost',     Icon: XCircle,        title: 'Closed lost',   subtitle: 'Stage moves itself', x: 866, y: 268, variant: 'lost' },
]
...
export const TOOLS: { Icon: Icon; label: string }[] = [
  ...
  { Icon: Sparkle,        label: 'Opportunities & pipeline' },
]
    ...
    >
      ...
      <header className="autopilot__head">
        ...
        <h2 id="autopilot-heading" className="autopilot__headline">
          A lead arrives. Nothing after it waits on you.
        </h2>
        <p className="autopilot__intro">
          Someone replies on Messenger or submits the form. The contact is tagged, an
          opportunity is created with an owner on it, and an hour later the workflow checks
          whether a booking happened. From there the pipeline moves itself: booked, reminded
          twice, then attended or not. Attended becomes a repeat client and a promo a week
          later; a no-show gets chased for a rebooking and, if none comes, three re-engagement
